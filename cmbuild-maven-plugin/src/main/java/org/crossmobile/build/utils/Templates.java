...
public class Templates {
    ...
    public static final String ANDROID_MANIFEST = ""
            ...
            + "    <application\n"
            + "        android:name=\"" + BUNDLEID_ANCHOR + "." + CURRENT_APPLICATION + "\"\n"
            + "        android:icon=\"@mipmap/" + ANDROID_ICON + "\"\n"
            + "        android:label=\"" + DISPLAYNAME_ANCHOR + "\"\n"
            + "        android:theme=\"@style/Theme.NoBackground.Fullscreen\"\n"
            ...
            + "        </provider>\n"
            + "        <activity\n"
            + "            android:name=\"" + BUNDLEID_ANCHOR + "." + CURRENT_ACTIVITY + "\"\n"
